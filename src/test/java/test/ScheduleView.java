...
import test.ScheduleExtenderService.ExtenderExample;
...
public class ScheduleView implements Serializable {
    ...
    @Inject
    private ScheduleExtenderService extenderService;
    ...
    public ScheduleExtenderService getScheduleExtenderService() {
        return extenderService;
    }

    public void setScheduleExtenderService(ScheduleExtenderService extenderService) {
