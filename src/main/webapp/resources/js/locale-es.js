if (window.PrimeFaces) {
  ...
  PrimeFaces.locales["es"] = $.extend(true, {}, PrimeFaces.locales["es"], {
    ...
    messages: {
      ...
      "jakarta.converter.BigDecimalConverter.DECIMAL": "{2}: '{0}' debe ser un número decimal positivo o negativo.",
      "jakarta.converter.BigDecimalConverter.DECIMAL_detail": "{2}: '{0}' debe ser un número decimal positivo o negativo formado por cero o más dígitos, que pueden incluir a continuación una coma decimal y una fracción.  Ejemplo: {1}",
      "jakarta.faces.converter.BigIntegerConverter.BIGINTEGER": "{2}: '{0}' debe ser un número formado por uno o más dígitos.",
      "jakarta.jakarta.converter.BigIntegerConverter.BIGINTEGER_detail": "{2}: '{0}' debe ser un número formado por uno o más dígitos. Ejemplo: {1}",
