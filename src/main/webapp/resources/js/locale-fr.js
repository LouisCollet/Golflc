if (window.PrimeFaces) {
  /* French utilisé à partir de 16-12-2024
   * https://github.com/primefaces/primefaces/tree/master/primefaces/src/main/resources/META-INF/resources/primefaces/locales*/
  ...
  PrimeFaces.locales["fr"] = $.extend(true, {}, PrimeFaces.locales["fr"], {
    ...
    messages: {
      ...
      "jakarta.faces.converter.ShortConverter.SHORT": "{2} : '{0}' doit ^étre un nombre décimal composé d'un ou plusieurs chiffres.",
