...
/*
 * Credit Card Number
https://github.com/sualeh/creditcardnumber/tree/master/src/main/java/us/fatehi/creditcardnumber
...
public enum MajorIndustryIdentifier{
 ...
 mii_9(9, "National assignment"),;
   ...
   * @return MII value.
   */
  public static MajorIndustryIdentifier MIIfrom(final String accountNumber) {
 //     LOG.debug("entering MIIfrom with accountNumber = " + accountNumber);
  ...
  //          LOG.debug("returning MIIfrom with = " + mii);
          return mii;
        }
      } //end for
    }
 //    LOG.debug("returning MIIfrom with = " + unknown);
    return unknown;
  }
