   ...
   //  String sourceDirectory = "C:/examples";
     ...
     */
      ...
      //check to see if this directory exists
         if(!dir.isDirectory()){
            LOG.debug(sourceDirectory + " is not a directory");
            return null;
         }else{
    ...
    LOG.debug("Zip file size = " + zipFile.length());
    return "OK";
}catch(ZipException z){
          LOG.debug("ZipException :" + z);
              return null;
...
void main() throws IOException{ // testing purposes
...
LOG.debug("number of entries = " + zipFile.size());
   Enumeration<? extends ZipEntry> enu = zipFile.entries();
   while (enu.hasMoreElements()){
    LOG.debug(" elements of zip = " + enu.nextElement()); 
   }
}// end main
} // end class