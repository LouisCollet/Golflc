...
// groupId maven : io.dropwizard.metrics
...
/**
 *https://www.baeldung.com/java-httpsessionlistener-metrics
 * @author Louis Collet
 */
public final class MetricRegistrySingleton {
    ...
    static {
        Logger logger = LoggerFactory.getLogger("org.baeldung.monitoring"); // c'est où ??
