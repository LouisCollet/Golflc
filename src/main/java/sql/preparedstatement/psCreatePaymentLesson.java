...
public class psCreatePaymentLesson implements Serializable, interfaces.Log, interfaces.GolfInterface {
    ...
    public static PreparedStatement psMapCreate(
        ...
        try {
            ...
            ps.setTimestamp(5, Timestamp.valueOf(lesson.getEventStartDate()));        // LessonStartDate
            ps.setTimestamp(6, Timestamp.valueOf(lesson.getEventEndDate()));          // LessonEndDate
            ...
            ps.setDouble(9, lesson.getLessonAmount() != null ? lesson.getLessonAmount() : 0.0); // LessonAmount
