...
//@ItemReader
public class ItemReaderRound extends AbstractItemReader implements interfaces.Log, interfaces.GolfInterface
{
    @Inject
...
59 	 */ 
    ...
    /**
     * 52 	 * The readItem method returns the next item 
53 	 * for chunk processing.54 	 * It returns null to indicate no more items, which 
55      * also means the current chunk will be committed and  
56      * the step will end. 
57 	 * @return next item or null 
58 	 * @throws Exception is thrown for any errors. 
