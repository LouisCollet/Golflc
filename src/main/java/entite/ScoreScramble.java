...
public ScoreScramble(){ // constructor
   ...
   //         LOG.debug(" array players initialized" + Arrays.deepToString(players) );
        holes = new String[18];
        Arrays.fill(holes, "0");
    //        LOG.debug(" array holes initialized" + Arrays.deepToString(holes) );
...
{       try {
   ...
   //         + NEW_LINE + " ,Score Array  : " + Arrays.deepToString(getScoreMP4() )
       //     + NEW_LINE + " ,Score String : " + getScoreString()
            ...
            LOG.debug("Exception in toString de ScoreScramble " + ex);
            return null;
        }
}
} // end class